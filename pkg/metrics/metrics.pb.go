...
const file_pkg_metrics_metrics_proto_rawDesc = "" +
	"\n" +
	"\x19pkg/metrics/metrics.proto\x12\ametrics\"\x90\x01\n" +
	"\x06Metric\x12\x0e\n" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB2Z0github.com/your-repo/your-project/internal/protob\x06proto3"
...
func file_pkg_metrics_metrics_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_metrics_metrics_proto_rawDesc), len(file_pkg_metrics_metrics_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
